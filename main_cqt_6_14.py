...
def main():
    ...
    for epoch in range(0, epoches-start_epoch):
        ...
        with open(Config["cqt_6_14"]["cqt_train_process_txt"].format(ff), 'a') as f:
            f.write(line)
        dir = Config["cqt_6_14"]["cqt_checkpoint"].format(ff)
        ...
        if is_best:
            ...
            dir_best = Config["cqt_6_14"]["cqt_model_best"].format(ff)
            print(dir_best)
