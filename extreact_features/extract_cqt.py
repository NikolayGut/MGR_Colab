...
test_example = '/Users/nikolaygut/Desktop/Diploma/fma_small/000/000002.mp3'
...
def load_melspectrogram(filename):
    ...
    for u in range(len(x_slice)):
        ...
        hop_length = 1024
        features = lbr.cqt(new_x, sr=22050, fmin=fmin, n_bins=84, hop_length=hop_length).T
        #import pudb;pu.db
...
if __name__ == '__main__':
    root = '/Users/nikolaygut/Desktop/Diploma/fma_small'
    dirs = ['000','001','002']
    for i in range(len(dirs)):
        if i>-1:
            ...
            output_path = '/Users/nikolaygut/Desktop/Diploma/fma_small_part_feat/cqt/{}.pkl'
