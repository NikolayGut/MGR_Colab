            ...
            if os.path.isdir(path_dir):
                ...
                for j in range(len(files_path)):
                    if j>-1:
                        ...
                        if j%20 == 0 and j>0:
                            output_path = '/Users/nikolaygut/Desktop/Diploma/fma_small_part_feat/scatter/{}_{}.pkl'
                            output_path = output_path.format(dirs[i],j)
                            with open(output_path, 'wb') as f1:
                                dump(content, f1)
                                print(output_path)
            output_path = '/Users/nikolaygut/Desktop/Diploma/fma_small_part_feat/scatter/{}.pkl'
