...
def main():
    ...
    model_graph = draw_graph(model, input_size=(2, 3, 300, 400), save_graph=True, filename="neural_network_graph", directory= '/Users/nikolaygut/Desktop/Diploma/results_cqt_copy',)
