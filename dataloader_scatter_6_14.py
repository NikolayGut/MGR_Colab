...
class datatype(object):
    ...
    def load(self):
        ...
        root = '/Users/nikolaygut/Desktop/Diploma/fma_small_part_feat/scatter'
        #root = '/home/zwj/mgr/ballroom_feat/harmonic'
        #root = '/home/zwj/mgr/ballroom_feat/cqt'
        dirs = os.listdir(root)
        dirs = [ i for i in dirs if i.endswith('.pkl')]
        dirs.sort()
        content = dict()
    ...
    def name_txt(self):
        txt_root = '/Users/nikolaygut/Desktop/Diploma/fma_small_part_feat/11_split_txt'
